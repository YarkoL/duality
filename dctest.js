...
This tests only the connecting with becausewhynot's 
webrtcnetwork plugin and using data channels. 
It uses only the functions in webrtcnetwork.js

This preliminary test is now superseded by testing 
video call in main.js
